...
function runthis()
{
    ...
    for(index in inputFiles)
    {
		...
		//alert(inputFiles[index].toString().replace("_diffuse.dds",""));
		//alert(GetFileName(String(inputFiles[index])));
		
        //var fileToOpen = new File(inputFiles[index] + "_diffuse.dds");
        //open(fileToOpen);
		...
		//var fileToOpen = new File(inputFiles[index] + "_orm.dds");
        //open(fileToOpen);
		...
		//var fileToOpen = new File(inputFiles[index] + "_normal.dds");
        //open(fileToOpen);
